...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/13 08:07:28 by malrandr          #+#    #+#             */
/*   Updated: 2025/08/13 11:26:32 by malrandr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_ping(int sig)
{
	if (sig == SIGUSR2)
		ft_printf("Server : Success ! :3\n");
}
